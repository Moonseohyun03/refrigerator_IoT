...
def read_current():
    ...
    try:
        ...
        for _ in range(samples):
            ...
            acc += v_ac ** 2
            time.sleep(0.001)
        v_rms = math.sqrt(acc / samples)
        current_rms = v_rms * CAL_FACTOR
...
def main(refrigerator_number: str, check_value: str):
    ...
    while True:
        ...
        # -------------------- CMD 출력 --------------------
        print(f"[센서값] DS18B20: {ds18b20_temp} °C | RS485: {rs485_temp} °C | 전류: {current_value} A")
